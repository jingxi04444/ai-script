...
const menuGroups: Array<{ title: string; items: MenuItem[] }> = [
  ...
  },
  {
    title: '资源与模板',
    items: [
      { label: '脚本模板管理', path: '/templates', icon: Database },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '站点配置', path: '/system/site-config', icon: Settings },
      { label: '首页轮播', path: '/system/home-banners', icon: Image },
...
const routeMeta: Record<string, { title: string; desc: string }> = {
  ...
  '/templates': { title: '脚本模板管理', desc: '维护可复用的脚本模板。' },
  ...
  '/system/site-config': { title: '站点配置', desc: '配置用户端首页展示和品牌图标。' },
