...
export const systemApi = {
  ...
  getPromptTemplates: (params?: { page?: number; pageSize?: number; keyword?: string }): Promise<PageResult<PromptTemplate>> => api.get('/system/prompt-templates', { params }),
  ...
  getImportTemplates: (params?: { page?: number; pageSize?: number; keyword?: string }): Promise<PageResult<ImportTemplate>> => api.get('/system/import-templates', { params }),
